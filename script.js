...
let lifetimeScore = parseInt(localStorage.getItem('revolutionariesScoreDE')) || 0;
let completedLessons = JSON.parse(localStorage.getItem('completedRevolutionariesLessonsDE')) || [];
...
const stations = [
    {file:"01_Izetbegovic.mp3", title:"1. Alija Izetbegović"},
    {file:"02_Cabral.mp3", title:"2. Amílcar Cabral"},
    {file:"03_Davis.mp3", title:"3. Angela Davis"},
    {file:"04_Shakur.mp3", title:"4. Assata Shakur"},
    {file:"05_Singh.mp3", title:"5. Bhagat Singh"},
    {file:"06_Sands.mp3", title:"6. Bobby Sands"},
    {file:"07_Guevara.mp3", title:"7. Che Guevara"},
    {file:"08_Gezmis.mp3", title:"8. Deniz Gezmiş"},
    {file:"09_Bouhired.mp3", title:"9. Djamila Bouhired"},
    {file:"10_Fanon.mp3", title:"10. Frantz Fanon"},
    {file:"11_Hampton.mp3", title:"11. Fred Hampton"},
    {file:"12_HoChiMinh.mp3", title:"12. Ho Chi Minh"},
    {file:"13_MalcolmX.mp3", title:"13. Malcolm X"},
    {file:"14_Mandela.mp3", title:"14. Nelson Mandela"},
    {file:"15_Mukhtar.mp3", title:"15. Omar Mukhtar"},
    {file:"16_Lumumba.mp3", title:"16. Patrice Lumumba"},
    {file:"17_Parks.mp3", title:"17. Rosa Parks"},
    {file:"18_Machel.mp3", title:"18. Samora Machel"},
    {file:"19_Biko.mp3", title:"19. Steve Biko"},
    {file:"20_Sankara.mp3", title:"20. Thomas Sankara"},
    {file:"21_Arafat.mp3", title:"21. Yasser Arafat"}
];
...
function finishQuiz() {
    lifetimeScore += totalScore; localStorage.setItem('revolutionariesScoreDE', lifetimeScore);
    const fn = decodeURIComponent(audio.src.split('/').pop());
    if(!completedLessons.includes(fn)) { 
        completedLessons.push(fn); 
        localStorage.setItem('completedRevolutionariesLessonsDE', JSON.stringify(completedLessons)); 
    }
    renderGrid(); 
